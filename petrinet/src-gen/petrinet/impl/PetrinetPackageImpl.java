...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EOperation getArc__DifferentNodeTypes__DiagnosticChain_Map() {
	 ...
	 */
	@Override
	public EOperation getPlace__NonNegativeTokens__DiagnosticChain_Map() {
	 ...
	 */
	@Override
	public EOperation getPetriNet__UniqueNodeNames__DiagnosticChain_Map() {
	...
	public void createPackageContents() {
		...
		createEOperation(arcEClass, ARC___DIFFERENT_NODE_TYPES__DIAGNOSTICCHAIN_MAP);

		transitionEClass = createEClass(TRANSITION);

		placeEClass = createEClass(PLACE);
		createEAttribute(placeEClass, PLACE__JETON);
		createEOperation(placeEClass, PLACE___NON_NEGATIVE_TOKENS__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(petriNetEClass, PETRI_NET___UNIQUE_NODE_NAMES__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNoeud_Name(), ecorePackage.getEString(), "name", null, 0, 1, Noeud.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNoeud_Ingoing(), this.getArc(), this.getArc_Target(), "ingoing", null, 0, -1, Noeud.class,
		...
		initEAttribute(getArc_Poid(), ecorePackage.getEInt(), "poid", null, 1, 1, Arc.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArc_Type(), this.getArcType(), "type", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Target(), this.getNoeud(), this.getNoeud_Ingoing(), "target", null, 1, 1, Arc.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = initEOperation(getArc__DifferentNodeTypes__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"DifferentNodeTypes", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getPlace__NonNegativeTokens__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"NonNegativeTokens", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(petriNetEClass, PetriNet.class, "PetriNet", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPetriNet_Arc(), this.getArc(), null, "arc", null, 0, -1, PetriNet.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPetriNet_Name(), ecorePackage.getEString(), "name", null, 0, 1, PetriNet.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPetriNet_Noeud(), this.getNoeud(), null, "noeud", null, 0, -1, PetriNet.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		op = initEOperation(getPetriNet__UniqueNodeNames__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"UniqueNodeNames", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(arcEClass, source, new String[] { "constraints", "DifferentNodeTypes" });
		addAnnotation(placeEClass, source, new String[] { "constraints", "NonNegativeTokens" });
		addAnnotation(petriNetEClass, source, new String[] { "constraints", "UniqueNodeNames" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(getArc__DifferentNodeTypes__DiagnosticChain_Map(), source, new String[] { "body",
		...
		addAnnotation(getPlace__NonNegativeTokens__DiagnosticChain_Map(), source,
				new String[] { "body", "self.jeton >= 0" });
		addAnnotation(getPetriNet__UniqueNodeNames__DiagnosticChain_Map(), source,
				new String[] { "body", "self.noeud->isUnique(name)" });
	}
