...
public interface PetrinetPackage extends EPackage {
	...
	/**
	 * The operation id for the '<em>Different Node Types</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ARC___DIFFERENT_NODE_TYPES__DIAGNOSTICCHAIN_MAP = 0;
	...
	/**
	 * The operation id for the '<em>Non Negative Tokens</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PLACE___NON_NEGATIVE_TOKENS__DIAGNOSTICCHAIN_MAP = NOEUD_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PLACE_OPERATION_COUNT = NOEUD_OPERATION_COUNT + 1;
	...
	/**
	 * The operation id for the '<em>Unique Node Names</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PETRI_NET___UNIQUE_NODE_NAMES__DIAGNOSTICCHAIN_MAP = 0;
	 ...
	 * @ordered
	 */
	int PETRI_NET_OPERATION_COUNT = 1;
	...
	/**
	 * Returns the meta object for the '{@link petrinet.Arc#DifferentNodeTypes(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Different Node Types</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Different Node Types</em>' operation.
	 * @see petrinet.Arc#DifferentNodeTypes(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getArc__DifferentNodeTypes__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link petrinet.Place#NonNegativeTokens(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Non Negative Tokens</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Non Negative Tokens</em>' operation.
	 * @see petrinet.Place#NonNegativeTokens(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPlace__NonNegativeTokens__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link petrinet.PetriNet#UniqueNodeNames(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Unique Node Names</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Unique Node Names</em>' operation.
	 * @see petrinet.PetriNet#UniqueNodeNames(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPetriNet__UniqueNodeNames__DiagnosticChain_Map();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Different Node Types</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation ARC___DIFFERENT_NODE_TYPES__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getArc__DifferentNodeTypes__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Non Negative Tokens</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PLACE___NON_NEGATIVE_TOKENS__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getPlace__NonNegativeTokens__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Unique Node Names</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PETRI_NET___UNIQUE_NODE_NAMES__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getPetriNet__UniqueNodeNames__DiagnosticChain_Map();
