...
import xtext.ide.contentassist.antlr.internal.InternalSimplepdlParser;
...
public class SimplepdlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimplepdlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getGuidanceAssignment_4_2(), "rule__WorkDefinition__GuidanceAssignment_4_2");
			builder.put(grammarAccess.getWorkDefinitionAccess().getGuidanceAssignment_4_3_1(), "rule__WorkDefinition__GuidanceAssignment_4_3_1");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getLinksToPredecessorsAssignment_6_2(), "rule__WorkDefinition__LinksToPredecessorsAssignment_6_2");
			builder.put(grammarAccess.getWorkDefinitionAccess().getLinksToPredecessorsAssignment_6_3_1(), "rule__WorkDefinition__LinksToPredecessorsAssignment_6_3_1");
