...
public class SimplePDLTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_WorkSequence = TypeId.BAG.getSpecializedId(SimplePDLTables.CLSSid_WorkSequence, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_WorkSequence = TypeId.SET.getSpecializedId(SimplePDLTables.CLSSid_WorkSequence, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _WorkDefinition__WorkSequence__predecessor = new ExecutorPropertyWithImplementation("WorkSequence", Types._WorkDefinition, 6, new EcoreLibraryOppositeProperty(SimplePDLPackage.Literals.WORK_SEQUENCE__PREDECESSOR));
		public static final ExecutorProperty _WorkDefinition__WorkSequence__successor = new ExecutorPropertyWithImplementation("WorkSequence", Types._WorkDefinition, 7, new EcoreLibraryOppositeProperty(SimplePDLPackage.Literals.WORK_SEQUENCE__SUCCESSOR));
		...
		public static final ExecutorProperty _WorkSequence__WorkDefinition__linksToPredecessors = new ExecutorPropertyWithImplementation("WorkDefinition", Types._WorkSequence, 4, new EcoreLibraryOppositeProperty(SimplePDLPackage.Literals.WORK_DEFINITION__LINKS_TO_PREDECESSORS));
		public static final ExecutorProperty _WorkSequence__WorkDefinition__linksToSuccessors = new ExecutorPropertyWithImplementation("WorkDefinition", Types._WorkSequence, 5, new EcoreLibraryOppositeProperty(SimplePDLPackage.Literals.WORK_DEFINITION__LINKS_TO_SUCCESSORS));
		static {
			Init.initEnd();
		}
